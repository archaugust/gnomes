...
class ArchProductVariantType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('variant_option_one_value', TextType::class, array('required' => false, 'label' => 'Value'))
            ...
            ->add('variant_option_two_value', TextType::class, array('required' => false, 'label' => 'Value'))
            ...
            ->add('variant_option_three_value', TextType::class, array('required' => false, 'label' => 'Value'))
