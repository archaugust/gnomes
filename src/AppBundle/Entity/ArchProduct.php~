...
class ArchProduct
{
    ...
    public function __construct() {
    	...
    	$this->price = $this->supply_price = $this->retail_price = $this->views = $this->count = $this->reorder_point = $this->restock_level = $this->adds = $this->pre_sell = 0;
    }
     ...
     * Set vendActive
     *
     * @param boolean $vendActive
     *
     * @return ArchProduct
     */
    public function setVendActive($vendActive)
    {
        $this->vend_active = $vendActive;
     ...
     * @return boolean
     */
    public function getVendActive()
    {
        return $this->vend_active;
    }
     ...
     * Set preSell
     *
     * @param boolean $preSell
     *
     * @return ArchProduct
     */
    public function setPreSell($preSell)
    {
        $this->pre_sell = $preSell;
